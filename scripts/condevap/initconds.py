...
E.g. execute
``
python ./scripts/condevap/initconds.py ~/CLEO/ /work/bm1183/m300950/validating_cleo/build \
...
from condevap.initconds import *
...
if __name__ == "__main__":
    ...
    parser.add_argument("is_plotfigs", type=str, choices=["TRUE", "FALSE"], help="=='TRUE' then make initial condition figures")
    parser.add_argument("is_savefigs", type=str, choices=["TRUE", "FALSE"], help="=='TRUE' then save initial condition figures")
